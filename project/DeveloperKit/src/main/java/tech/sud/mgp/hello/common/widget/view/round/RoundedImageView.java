...
package tech.sud.mgp.hello.common.widget.view.round;
...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerRadii[Corner.BOTTOM_RIGHT] = a.getDimensionPixelSize(
                R.styleable.RoundedImageView_riv_corner_radius_bottom_right, -1);
    ...
    public void setBorderWidthDimen(@DimenRes int resId) {
