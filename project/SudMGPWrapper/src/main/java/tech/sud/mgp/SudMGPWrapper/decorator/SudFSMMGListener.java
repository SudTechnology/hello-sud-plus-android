...
public interface SudFSMMGListener {
     ...
     */
    default void onGameMGCommonAiMessage(ISudFSMStateHandle handle, SudMGPMGState.MGCommonAiMessage model) {
        ISudFSMStateHandleUtils.handleSuccess(handle);
    }
     ...
     * 64. 通知app ai大模型消息
     */
    default void onGameMGCommonAiLargeScaleModelMsg(ISudFSMStateHandle handle, SudMGPMGState.MGCommonAiLargeScaleModelMsg model) {
        ISudFSMStateHandleUtils.handleSuccess(handle);
    }
     ...
     */
    default void onGameMGCommonGamePlayerMicState(ISudFSMStateHandle handle, SudMGPMGState.MGCommonGamePlayerMicState model) {
        ISudFSMStateHandleUtils.handleSuccess(handle);
    }
