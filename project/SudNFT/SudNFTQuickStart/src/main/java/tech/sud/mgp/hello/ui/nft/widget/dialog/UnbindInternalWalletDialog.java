...
public class UnbindInternalWalletDialog extends BaseDialogFragment {
    ...
    public static UnbindInternalWalletDialog newInstance(SudNFTGetWalletListModel.WalletInfo walletInfo) {
        Bundle args = new Bundle();
        args.putSerializable("WalletInfo", walletInfo);
        UnbindInternalWalletDialog fragment = new UnbindInternalWalletDialog();
    ...
    protected int getLayoutId() {
        return R.layout.dialog_unbind_internal_wallet;
    }
    ...
    protected void initData() {
        super.initData();
        tvTitle.setText(getString(R.string.unbind_internal_wallet_title, walletInfo.name));
    }
