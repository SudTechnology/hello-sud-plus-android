...
public class GlobalSP {
    ...
    public final static String KEY_USER_WALLET_ADDRESS = "key_user_wallet_address"; // 登录的钱包地址
    public final static String KEY_USER_WALLET_ZONE_TYPE = "key_user_wallet_zone_type"; // 绑定的钱包区域
