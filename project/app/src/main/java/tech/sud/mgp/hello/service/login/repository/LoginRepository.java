...
public class LoginRepository {
    ...
    public static void saveUserInfo() {
        GlobalSP.getSP().put(GlobalSP.USER_ID_KEY, HSUserInfo.userId, true);
        GlobalSP.getSP().put(GlobalSP.USER_HEAD_PORTRAIT_KEY, HSUserInfo.avatar, true);
        GlobalSP.getSP().put(GlobalSP.USER_NAME_KEY, HSUserInfo.nickName, true);
        GlobalSP.getSP().put(GlobalSP.USER_TOKEN_KEY, HSUserInfo.token, true);
        GlobalSP.getSP().put(GlobalSP.USER_REFRESHTOKEN_KEY, HSUserInfo.refreshToken, true);
        GlobalSP.getSP().put(GlobalSP.USER_HEADER_TYPE_KEY, HSUserInfo.headerType, true);
        GlobalSP.getSP().put(GlobalSP.KEY_USER_HEADER_NFT_URL, HSUserInfo.headerNftUrl, true);
    }
