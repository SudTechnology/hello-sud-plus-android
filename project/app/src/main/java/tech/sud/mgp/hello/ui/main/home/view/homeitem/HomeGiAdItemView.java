 ...
 * 3D语聊房场景
 */
public class HomeGiAdItemView extends ConstraintLayout implements IHomeChildItemView {
    ...
    public HomeGiAdItemView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public HomeGiAdItemView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public HomeGiAdItemView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    private void init(Context context) {
        inflate(context, R.layout.view_home_gi_ad_item, this);
