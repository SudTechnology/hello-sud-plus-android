package tech.sud.mgp.hello.ui.main.performance;
...
public class PerformanceFloatingView extends ConstraintLayout {
    ...
    public PerformanceFloatingView(@NonNull Context context) {
        this(context, null);
    }

    public PerformanceFloatingView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PerformanceFloatingView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        inflate(getContext(), R.layout.view_performance_floating, this);
