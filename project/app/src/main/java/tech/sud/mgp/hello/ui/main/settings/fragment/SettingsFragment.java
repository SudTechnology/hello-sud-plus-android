...
import tech.sud.mgp.hello.ui.scenes.openpass.TestOpenPassActivity;
...
public class SettingsFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onMessageEvent(NftTokenInvalidEvent event) {
        LifecycleUtils.safeLifecycle(this, () -> nftViewModel.initData(requireContext()));
    }
    ...
    private void setClickListeners() {
        ...
        findViewById(R.id.button_test_game).setOnClickListener(v -> {
            startActivity(new Intent(requireContext(), TestOpenPassActivity.class));
        });
    }
