...
public class DiscoGameViewModel extends AppGameViewModel {
    ...
    public void switchSong(String musicId, String speed) {
        ...
        String field2 = speed;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_SWITCH_SONG, cooldown, isTop, field1, field2);
    }
    ...
    public void bindGender(boolean bind) {
        ...
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_BIND_GENDER, cooldown, isTop, field1, field2);
    }
    ...
    public void changeRole(String roleId) {
        ...
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_CHANGE_ROLE, cooldown, isTop, field1, field2);
    }
    ...
    public void joinAnchor(String position) {
        ...
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_JOIN_ANCHOR, cooldown, isTop, field1, field2);
    }
    ...
    public void leaveAnchor(String userId) {
        ...
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_LEAVE_ANCHOR, cooldown, isTop, field1, field2);
    }
    ...
    public void hideCenterStage(boolean isHide) {
        ...
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_HIDE_CENTER_STAGE, cooldown, isTop, field1, field2);
    }
    ...
    public void joinDancingFloor(String color) {
        ...
        String field1 = color;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_JOIN_DANCING_FLOOR, cooldown, isTop, field1, field2);
    }
    ...
    public void leaveDancingFloor(String userId) {
        ...
        String field1 = userId;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_LEAVE_DANCING_FLOOR, cooldown, isTop, field1, field2);
    }
    ...
    public void clearSite() {
        ...
        String field1 = null;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_CLEAR_SITE, cooldown, isTop, field1, field2);
    }
    ...
    public void roleMove(Integer cooldown, String speed) {
        ...
        String field1 = speed;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_ROLE_MOVE, cooldown, isTop, field1, field2);
    }
     ...
     */
    public void roleBig(Integer cooldown, String multiple) {
        Boolean isTop = null;
        String field1 = multiple;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_ROLE_BIG, cooldown, isTop, field1, field2);
    }
    ...
    public void roleFly(Integer cooldown) {
        ...
        String field1 = null;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_ROLE_FLY, cooldown, isTop, field1, field2);
    }
    ...
    public void roleEffects(Integer cooldown, String effectId) {
        ...
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_ROLE_EFFECTS, cooldown, isTop, field1, field2);
    }
    ...
    public void roleFocus(Integer cooldown, Boolean isTop) {
        String field1 = null;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_ROLE_FOCUS, cooldown, isTop, field1, field2);
    }
    ...
    public void textPop(Integer cooldown, String content) {
        ...
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_TEXT_POP, cooldown, isTop, field1, field2);
    }
    ...
    public void roleTitle(Integer cooldown, String text, String effectId) {
        ...
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_ROLE_TITLE, cooldown, isTop, field1, field2);
    }
    ...
    public void upDJ(Integer cooldown) {
        ...
        String field1 = null;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_UP_DJ, cooldown, isTop, field1, field2);
    }
    ...
    public void danceMode(int mode) {
        ...
        String field1 = mode + "";
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_DANCE_MODE, cooldown, isTop, field1, field2);
    }
    ...
    public void anchorDance(Integer cooldown, Boolean isTop, String userId) {
        String field1 = userId;
        String field2 = null;
        sudFSTAPPDecorator.notifyAppCommonGameDiscoAction(ACTION_ANCHOR_DANCE, cooldown, isTop, field1, field2);
    }
