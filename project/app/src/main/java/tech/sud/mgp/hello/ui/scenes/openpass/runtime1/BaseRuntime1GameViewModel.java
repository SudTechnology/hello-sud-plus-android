...
public abstract class BaseRuntime1GameViewModel implements SudFSMMGListener {
     ...
     */
    private final SudRuntime1FSMMGDecorator sudFSMMGDecorator = new SudRuntime1FSMMGDecorator();
    ...
    private void initEnv() {
        SudGIP.getCfg().getAdvancedConfigMap().put(ISudCfg.IS_TEST_ENV, isTestEnv() + "");
        EnvUtils.initMgpEnv();
    }
...
//        sudLoadMGParamModel.language = getLanguageCode();
        ISudRuntime1FSTAPP iSudRuntime1FSTAPP = SudRuntime1.loadGame(sudLoadMGParamModel, sudFSMMGDecorator);
    ...
    public void onGameLoadingProgress(int stage, int retCode, int progress) {
        ...
        LogUtils.d("onGameLoadingProgress:" + stage + " retCode:" + retCode + " progress:" + progress);
    }
