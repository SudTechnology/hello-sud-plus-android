 ...
 * 根据{@link LinePagerIndicator}进行修改，只在两边有圆角，中间部分没有圆角
 */
public class CustomLinePagerIndicator extends View implements IPagerIndicator {
    ...
    private RectF clipRectF = new RectF(0, 0, 0, 0);
    private float rids[] = {mRoundRadius, mRoundRadius, mRoundRadius, mRoundRadius, mRoundRadius, mRoundRadius, mRoundRadius, mRoundRadius};
...
//        canvas.drawRoundRect(mLineRect, mRoundRadius, mRoundRadius, mPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        path.reset();
        clipRectF.right = getMeasuredWidth();
        clipRectF.bottom = getMeasuredHeight();
        path.addRoundRect(clipRectF, rids, Path.Direction.CW);
    }
